    ...
    <section className="c-space section-spacing" id="about">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12">
        ...
        <div className="flex items-end grid-default-color grid-1">
          ...
          />
          <div className="z-10">
            <p className="headtext">Hi, I'm Matias Torres</p>
            <p className="subtext">
              A passionate software developer with a knack for creating
              efficient and scalable solutions. I love turning complex problems
        ...
        <div className="grid-default-color grid-2">
          ...
          >
            ...
            />
            <Card
              style={{ rotate: "90deg", top: "25%", left: "60%" }}
              text="CRUD"
              containerRef={grid2Container}
            />
            <Card
            ...
            />
            <Card
              style={{ rotate: "30deg", top: "65%", left: "65%" }}
              text="DAO"
              containerRef={grid2Container}
            />
            <Card
            ...
            />
            <Card
              style={{ rotate: "45deg", top: "8%", left: "10%" }}
        ...
        <div className="grid-black-color grid-3">
          <div className="z-10 w-[50%]">
            ...
            <p className="subtext">
              I'm based in Argentina, and open to remote work worldwide
            </p>
          </div>
